...
def main():
    ...
    X_train, y_train, feature_cols, trade_labels, train_dates = build_train_dataset()
    X_test, test_times, _, test_dates = build_test_dataset()
    ...
    if args.mode in ("full", "train"):
        ...
        model, val_metrics = train_model(X_train, y_train, feature_dim, trade_labels, train_dates)
    ...
    predictions = predict(X_test, feature_dim, MODEL_PATH, test_dates)
