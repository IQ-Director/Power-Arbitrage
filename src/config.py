...
# ==================== 离线 RL ====================
RL_HIDDEN_DIM = 96          # BiLSTM hidden（小于默认128，防过拟合）
RL_NUM_LAYERS = 1           # LSTM 层数（1 层减少参数）
RL_EMBED_DIM = 48           # 输入嵌入维度（小于默认64）
RL_ENTROPY_WEIGHT = 0.5     # PG 熵正则系数
RL_MODEL_PATH = os.path.join(MODEL_DIR, "best_model_rl.pt")
